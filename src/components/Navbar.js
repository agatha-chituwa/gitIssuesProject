...
function Footer() {
    ...
    &copy; 2021 GitHub, Inc. <a className="footer" href="#">Privacy</a>  <a className="footer" href="#">Terms</a>
    <a className="footer" href="#">security</a>
     <a className="footer" href="#">status</a>
    <a className="footer" href="#">docs</a>
